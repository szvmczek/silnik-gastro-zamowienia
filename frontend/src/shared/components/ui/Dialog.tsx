...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {showClose ? (
        <RadixDialog.Close
          className="absolute right-4 top-4 rounded-sm p-1 text-slate-500 opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:pointer-events-none"
          aria-label="Zamknij"
        >
          <X className="h-4 w-4" />
        </RadixDialog.Close>
