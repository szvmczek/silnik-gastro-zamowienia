...
// Placeholder do zastąpienia w M-039 (bundle: v2-stage4/section-operations.jsx).
  ...
  return (
    <>
      ...
      <SettingsStub
        ...
        bodyText="Domyślny czas przygotowania (auto-ETA), minimum zamówienia, tymczasowe zamknięcie restauracji i metody płatności pojawią się w M-039. Bundle referencja: docs/design/v2-stage4/section-operations.jsx."
      />
    </>
  );
}
